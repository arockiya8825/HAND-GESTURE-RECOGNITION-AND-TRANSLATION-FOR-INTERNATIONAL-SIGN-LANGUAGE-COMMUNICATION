...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model('J:\\Final Year Project\\Updated Sign-Language-to-Speech\\Sign-Language-To-Text-and-Speech-Conversion\\cnn8grps_rad1_model.h5')
        ...
        self.panel = tk.Label(self.root,bg=bgColor)
        self.panel.place(x=350, y=13, width=400, height=600)

        self.panel2 = tk.Label(self.root,bg="white")  # initialize image panel
        self.panel2.place(x=800, y=73, width=400, height=480)

        self.T = tk.Label(self.root)
        self.T.place(x=560, y=5)
        self.T.config(text="Gesture Voice Bridge",fg="white", font=("ubuntu-mono", 30, "bold"), bg=bgColor)

        self.panel3 = tk.Label(self.root,bg=bgColor,fg="white")  # Current Symbol
        self.panel3.place(x=300, y=585)

        self.T1 = tk.Label(self.root,bg=bgColor)
        self.T1.place(x=80, y=580)
        self.T1.config(text="Character :",fg="white", font=("ubuntu-mono", 30, "bold"))

        self.panel5 = tk.Label(self.root,bg=bgColor,fg="white")  # Sentence
        self.panel5.place(x=279, y=639)

        self.T3 = tk.Label(self.root,bg=bgColor)
        self.T3.place(x=80, y=632)
        self.T3.config(text="Sentence :",fg="white", font=("ubuntu-mono", 30, "bold"),bg=bgColor)

        self.T4 = tk.Label(self.root,bg=bgColor)
        self.T4.place(x=680, y=700)
        self.T4.config(text="Suggestions", fg="white", font=("ubuntu-mono", 25, "bold"),bg=bgColor)

        self.b1=tk.Button(self.root,bg=btnbgColor, fg="black",bd=0, relief=tk.FLAT, borderwidth=0, highlightthickness=0, padx=10, pady=5)
        self.b1.place(x=400,y=760)

        self.b2 = tk.Button(self.root,bg=btnbgColor, fg="black",bd=0, relief=tk.FLAT, borderwidth=0, highlightthickness=0, padx=10, pady=5)
        self.b2.place(x=600, y=760)

        self.b3 = tk.Button(self.root,bg=btnbgColor,fg="black", bd=0, relief=tk.FLAT, borderwidth=0, highlightthickness=0, padx=10, pady=5)
        self.b3.place(x=800, y=760)

        self.b4 = tk.Button(self.root,bg=btnbgColor,fg="black", bd=0, relief=tk.FLAT, borderwidth=0, highlightthickness=0, padx=10, pady=5)
        self.b4.place(x=1000, y=760)

        self.speak = tk.Button(self.root,bg=btnbgColor, fg="black",bd=0, relief=tk.FLAT, borderwidth=0, highlightthickness=0, padx=10, pady=5)
        self.speak.place(x=1335, y=630)
        self.speak.config(text="Speak", font=("ubuntu-mono", 20), wraplength=100, command=self.speak_fun)

        self.clear = tk.Button(self.root,bg=btnbgColor,fg="black", bd=0, relief=tk.FLAT, borderwidth=0, highlightthickness=0, padx=10, pady=5)
        self.clear.place(x=1205, y=630)
        self.clear.config(text="Clear", font=("ubuntu-mono", 20), wraplength=100, command=self.clear_fun)
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread("J:\\Final Year Project\\Updated Sign-Language-to-Speech\\Sign-Language-To-Text-and-Speech-Conversion\\white.jpg")
                ...
                if handz:
                    ...
                    for t in range(17, 20, 1):
                        cv2.line(white, (self.pts[t][0] + os, self.pts[t][1] + os1), (self.pts[t + 1][0] + os, self.pts[t + 1][1] + os1),
                                 (23, 32, 48), 3)
                    cv2.line(white, (self.pts[5][0] + os, self.pts[5][1] + os1), (self.pts[9][0] + os, self.pts[9][1] + os1), (23, 32, 48),
                             3)
                    cv2.line(white, (self.pts[9][0] + os, self.pts[9][1] + os1), (self.pts[13][0] + os, self.pts[13][1] + os1), (23, 32, 48),
                             3)
                    cv2.line(white, (self.pts[13][0] + os, self.pts[13][1] + os1), (self.pts[17][0] + os, self.pts[17][1] + os1),
                             (23, 32, 48), 3)
                    cv2.line(white, (self.pts[0][0] + os, self.pts[0][1] + os1), (self.pts[5][0] + os, self.pts[5][1] + os1), (23, 32, 48),
                             3)
                    cv2.line(white, (self.pts[0][0] + os, self.pts[0][1] + os1), (self.pts[17][0] + os, self.pts[17][1] + os1), (23, 32, 48),
                             3)
